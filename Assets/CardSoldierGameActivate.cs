...
{
    public GameObject CardSoldierWords;   // 提示 UI
    ...
    private void Start()
    {
        ...
        CardSoldierWords.SetActive(false);
    ...
    {
        CardSoldierWords.SetActive(true);
        ...
        else if (wandUI != null && wandUI.activeSelf)
        {
            ...
            infoTextUI.text = LanguageManager.Instance.GetLocalizedString("CardSoldierGameHint");
        }
        else
        {
            ...
            if (infoTextUI != null)
            {
                ...
                infoTextUI.text = LanguageManager.Instance.GetLocalizedString("CardSoldierNoWand");
            }
        }
    }
}
